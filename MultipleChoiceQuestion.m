...
-(UIView*)setupWithQuestion:(NSString*)questionString questionNumber:(NSString*)questionNumber MultiAnswers:(NSArray*) answerStrings mode:(multipleChoiceMode)mode
{
    ...
    //--Set up answers------//
    multipleChoiceViewController=[[MultipleChoiceViewController alloc]init];
    UIView* answerView=[multipleChoiceViewController setupWithMultiAnswers:answerStrings mode:mode];
